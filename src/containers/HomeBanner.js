  ...
  render() {
    return (
      <div className="home-banner">
        ...
        <div className="row">
          <div
            className="col-md-12 d-flex justify-content-center align-items-center logo-big-0"
            style={{
          ...
          <div className="col-md-12 quote d-flex justify-content-center align-items-center text-center">
            <div>
